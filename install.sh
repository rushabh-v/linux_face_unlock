...
chmod -w cli_setup.sh cli.sh getFaces.py add_new.py compare.py pam_ptn.py comm_auth_orig.py remove_cli.py  roots
chattr +i cli_setup.sh cli.sh getFaces.py add_new.py compare.py pam_ptn.py comm_auth_orig.py remove_cli.py  roots
./cli_setup.sh
. ~/.bashrc
